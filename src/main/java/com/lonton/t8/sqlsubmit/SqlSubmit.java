...
package com.lonton.t8.sqlsubmit;

import com.lonton.t8.sqlsubmit.cli.CliOptions;
import com.lonton.t8.sqlsubmit.cli.CliOptionsParser;
import com.lonton.t8.sqlsubmit.cli.SqlCommandParser;
import com.lonton.t8.sqlsubmit.cli.SqlCommandParser.SqlCommandCall;
...
public class SqlSubmit {
    ...
    private void run() throws Exception {
        ...
        tEnv.execute("Flink-SQL-Job-"+df.format(new Date()));
    }
